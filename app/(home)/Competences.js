				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8 ">
					<div className="text-content mt-8">
						<p>
							...
							votre site sur-mesure, 100% responsive, performant,
							fiable et évolutif. En vous dotant d’un site
							internet à la hauteur de vos ambitions, nous vous
							rendrons visible sur internet pour que vos clients
							accèdent à votre offre, n’importe où, n’importe
							quand.
						</p>
						<p>
							Oui, chacun son métier. Le vôtre, être un expert
							dans votre domaine. Le nôtre, booster votre présence
							en ligne.
						</p>
						<p className="mb-10">
							Découvrez tout de suite{" "}
							<Link href="/prestations">nos prestations</Link> et
							trouvez celle adaptée à vos besoins !
						</p>
						<CustomButton>
